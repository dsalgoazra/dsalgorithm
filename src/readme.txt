...
Graph
1) Dijkstra Algorithm:implemented using Priority Queue with comprehensive object priented implementation of Graph.
...
2) Detect Smallest Cycle In Graph: Check cycle from each vertex in the graph and returns the smallets one.
...
4) Find Sucessor of a given node in a binary tree 
